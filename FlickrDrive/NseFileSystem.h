...
typedef enum VFS_CONFIG {
   ...
   VFS_CAN_ROOT_SENDTO,                              // Has SendTo shell integration
   VFS_CAN_ROOT_PREVIEW,                             // Has Preview shell integration
   VFS_CAN_ROOT_SHELLNEW,                            // Has NewItem shell integration
   VFS_CAN_ROOT_PROPSHEET,                           // Has PropertySheet shell integration
   VFS_CAN_ROOT_DROPTARGET,                          // Has DropTarget shell integration
   VFS_CAN_ROOT_PROPERTIES,                          // Has custom Properties shell integration
   VFS_CAN_ROOT_CONTEXTMENU,                         // Has ContextMenu shell integration
   VFS_CAN_ROOT_URLPROTOCOL,                         // Has URL Protocol search integration
   VFS_CAN_ROOT_CUSTOMSCRIPT,                        // Has a custom registry script
   VFS_CAN_ROOT_STARTMENU_LINK,                      // Installs a shortcut in Start Menu
